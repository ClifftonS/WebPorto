...
export const TextRevealCard = ({ text, revealText, children, className }) => {
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn("flex items-center justify-center w-full  relative overflow-hidden", className)}
    >
      {children}
      <div className="h-15 relative flex items-center overflow-hidden">
        ...
        >
          <p
            ...
            className="text-2xl  py-6 font-bold lg:text-4xl md:text-3xl text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300"
          >
            {revealText}
          </p>
        </motion.div>
        ...
        <div className="overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="text-2xl lg:text-4xl md:text-3xl py-6 font-bold bg-clip-text text-gray-400 ">{text}</p>
          <MemoizedStars />
        </div>
      </div>
    </div>
