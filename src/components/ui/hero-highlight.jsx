...
export const HeroHighlight = ({ children, className, containerClassName }) => {
  ...
  return (
    <div className={cn("relative  flex items-center bg-black justify-center w-full group", containerClassName)} onMouseMove={handleMouseMove}>
...
export const Highlight = ({ children, className }) => {
  return (
    <motion.span
      ...
      className={cn(`relative inline-block pb-1   px-1 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500`, className)}
    >
      {children}
    </motion.span>
  );
