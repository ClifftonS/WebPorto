...
const dockVariants = cva("supports-backdrop-blur:bg-black/10 mx-auto hidden md:flex mt-8 lg:h-[40px] md:h-[32px] h-[24px] w-max gap-2 rounded-2xl border p-2 backdrop-blur-md");
